...
class ModeloUsuario
{
    ...
    static public function create($tabla,$datos){
        $stmt = Conexion::conectarProduccion()->prepare("INSERT INTO $tabla(nombre, apellido, cedula, correo, fecha_creacion, pass, padlock, keylock,activo) VALUES (:nombre, :apellido, :cedula, :correo, :fecha_creacion, :pass, :padlock, :keylock, :activo)");
    ...
    static public function update($tabla,$datos){
        $stmt = Conexion::conectarProduccion()->prepare("UPDATE $tabla SET nombre=:nombre, apellido=:apellido, cedula=:cedula, correo=:correo, pass=:pass, padlock=:padlock, keylock=:keylock, activo=:activo WHERE id_usuario=:id_usuario");
