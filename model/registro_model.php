...
class ModeloRegistro
{
    ...
    {
        $sql="Select re.fecha_hora_inicio,re.fecha_hora_fin,re.activo,re.id_registro, re.id_personal, re.id_informe, concat(per.nombre,' ',per.apellido) as personal from $tabla re, personal per
    ...
    {
        $stmt = Conexion::conectarProduccion()->prepare("UPDATE $tabla SET fecha_hora_inicio=:fecha_hora_inicio, fecha_hora_fin=:fecha_hora_fin, activo=:activo ,id_personal=:id_personal, id_informe=:id_informe WHERE id_registro = :id_registro");
