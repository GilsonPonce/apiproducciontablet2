...
class ModeloColor
{
    ...
    {
        $stmt = Conexion::conectarProduccion()->prepare("SELECT * FROM $tabla WHERE id_color=:id_color");
    ...
    {
        $stmt = Conexion::conectarProduccion()->prepare("UPDATE $tabla SET nombre=:nombre WHERE id_color=:id_color");
    ...
    static public function delete($tabla, $id){
		...
		$stmt = Conexion::conectarProduccion()->prepare("DELETE FROM $tabla WHERE id_color = :id_color");
